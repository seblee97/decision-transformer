...
parser.add_argument('--data_dir_prefix', type=str, default='/mnt/home/slee1/decision-transformer/dataset/')
...
tconf = TrainerConfig(max_epochs=epochs, batch_size=args.batch_size, learning_rate=6e-4,
                      ...
                      ckpt_path=os.path.join(exp_path), kd_env_path=kd_env_path)
